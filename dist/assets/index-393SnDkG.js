...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ba(e,t,n){let r=new Float32Array(oa),i=new J(0,1,0);return new $r({name:`SphericalGaussianBlur`,defines:{n:oa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xa(){return new $r({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Sa(){return new $r({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ca(),fragmentShader:`
	...
	`}var wa=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,vc={time:{type:`f`,value:0}},yc=new Dr(new Wr(256,256,256,256),new ei({uniforms:vc,vertexShader:gc,fragmentShader:_c,transparent:!0}));pc.add(yc),mc.position.set(0,16,125),mc.lookAt(new J(0,28,0)),fc.setSize(window.innerWidth,window.innerHeight),fc.setClearColor(0,0);function bc(){mc.aspect=window.innerWidth/window.innerHeight,mc.updateProjectionMatrix(),fc.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,bc),window.__heroMesh={camera:mc},(function e(){requestAnimationFrame(e),vc.time.value+=hc.getDelta()*.5,fc.render(pc,mc)})();